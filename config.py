...
def gen_args():
    ...
    parser.add_argument('--loss_fn', required=False, default='cd')
    ...
    parser.add_argument('--pool_type', required=False, default='max')
    ...
    args.save_path = create_directory(os.path.join(args.save_path, args.model_type, f'{args.model_type}-{args.num_input}', f'seed_{args.seed}', f'version_{args.ver}'))
